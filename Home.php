...
<body>
	...
	<header class="header">
		...
		<div class="header_1">
			...
			<a href="#" class="slogan"><i class="#"></i>Job Hunting<br>made easy!</a>
	...
	<section class="aisles" id="aisles">
		...
		<h1 class="heading"> Jobs <span>Available</span> </h1>
	...
	<footer>
		...
		<div class="footer_bottom">
			 JobHunter.com ~ designed by BellyGeek
		</div>
